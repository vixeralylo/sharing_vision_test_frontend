              ...
              <CForm>
                ...
                <div className="mb-3">
                  ...
                  <div className="form-check">
                      <input defaultChecked={this.state.status === 'PUBLISH' ? true : false} style={{fontSize:'12px',marginTop:'7px'}} onChange= {this.handleChangeStatus} className="form-check-input" type="radio" value="PUBLISH" name="radio_status"></input>
                      <label className="form-check-label" style={{fontSize:'14px'}}>PUBLISH</label>
                  </div>
                  <div className="form-check">
                      <input defaultChecked={this.state.status === 'DRAFT' ? true : false} style={{fontSize:'12px',marginTop:'7px'}} onChange= {this.handleChangeStatus} className="form-check-input" type="radio" value="DRAFT" name="radio_status"></input>
                      <label className="form-check-label" style={{fontSize:'14px'}}>DRAFT</label>
                  </div>
                  <div className="form-check">
                      <input defaultChecked={this.state.status === 'TRASH' ? true : false} style={{fontSize:'12px',marginTop:'7px'}} onChange= {this.handleChangeStatus} className="form-check-input" type="radio" value="TRASH" name="radio_status"></input>
                ...
                <CCol xs>
                  ...
                  <CButton onClick={() => this.SaveArticle()} component="a" color="primary" role="button">
                    Add
                  </CButton>
                </CCol>
              </CForm>
